                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="sellForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback text-danger" style="display: none;">Please select a customer.</div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="sale_stock" class="form-label">Quantity Sold: <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="sale_stock" placeholder="Enter Quantity Sold" name="sale_stock" required>
                                    <div class="invalid-feedback text-danger" style="display: none;">Please enter a valid quantity.</div>
                                </div>
                                <div class="mb-3">
                                    <label for="price" class="form-label">Unit Price: <small>(from product)</small></label>
                                    <input type="number" step="0.01" class="form-control" id="price" name="price" readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="total_price" class="form-label">Total Price: <small>(calculated)</small></label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btnsave" aria-label="Save sale">Save</button>
