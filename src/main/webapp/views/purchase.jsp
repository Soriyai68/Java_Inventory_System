...
<head>
    ...
    * {
    ...
    /* Add New Purchase Button Styling */
    #btnadd {
                ...
                <div class="table-responsive">
                    <table id="table_id" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="Purchase ID">PUR001</td>
                                <td data-label="Supplier">Tech Supplies</td>
                                <td data-label="Product">Laptop</td>
                                <td data-label="Date">2025-04-19</td>
                                <td data-label="Status">Received</td>
                                <td data-label="Stock">10</td>
                                <td data-label="Cost Price">$500.00</td>
                                <td data-label="Description">Bulk order</td>
                                <td data-label="Option">
                                    <button class="btn btn-success btn-sm" aria-label="Edit purchase">Edit</button>
                                    <button class="btn btn-danger btn-sm" aria-label="Delete purchase">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="purchaseForm">
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback text-danger" style="display: none;">Please select a supplier.</div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback text-danger" style="display: none;">Please select a status.</div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3 price-input-wrapper">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="cost_price" placeholder="Enter Cost Price" name="cost_price" required>
                                    <div class="invalid-feedback text-danger" style="display: none;">Please enter a valid cost price.</div>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btnsave" aria-label="Save purchase">Save</button>
