                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Actions">
                                    <button class="btn btn-success btn-sm" aria-label="Edit customer">Edit</button>
                                    <button class="btn btn-danger btn-sm" aria-label="Delete customer">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btnsave" aria-label="Save customer">Save</button>
