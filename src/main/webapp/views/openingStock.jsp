...
<head>
    ...
    <link rel="preload" href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;700&family=Poppins:wght@400;500&display=swap" as="style" onload="this.rel='stylesheet'">
    <!-- GSAP Library -->
    ...
    <style>
        ...
        * {
        ...
        .form-control::placeholder, .form-control textarea::placeholder, .form-control select::placeholder {
...
<body>
                ...
                <div class="table-responsive">
                    <table id="table_id" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="Stock ID">OS001</td>
                                <td data-label="Product">Laptop</td>
                                <td data-label="Stock">50</td>
                                <td data-label="Date">2025-04-19</td>
                                <td data-label="Description">Initial stock</td>
                                <td data-label="Option">
                                    <button class="btn btn-success btn-sm" aria-label="Edit stock">Edit</button>
                                    <button class="btn btn-danger btn-sm" aria-label="Delete stock">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btnsave" aria-label="Save stock">Save</button>
    ...
    <script src="scripts/openingStock.js"></script>
    <script>
