                ...
                <div class="table-responsive">
                    <table id="table_id" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="Category ID">CAT001</td>
                                <td data-label="Category Name">Electronics</td>
                                <td data-label="Code">ELEC</td>
                                <td data-label="Description">Electronic devices and gadgets</td>
                                <td data-label="Option">
                                    <button class="btn btn-success btn-sm" aria-label="Edit category">Edit</button>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btnsave" aria-label="Save category">Save</button>
