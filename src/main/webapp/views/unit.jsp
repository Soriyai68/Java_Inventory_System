...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a href="layout?action=users"><i class="fas fa-users"></i> Prepare Users</a>
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="button-container">
                    <button type="button" id="btnadd" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Unit Form</h4>
                        ...
                        <div class="modal-body">
                            <form id="unitForm">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="unit_name" placeholder="Enter Unit Name" required>
                                </div>
                                <div class="mb-3">
                                    <label for="subname" class="form-label">Subname: <span class="text-danger" >*</span></label>
                                    <input type="text" class="form-control" id="sub_name" name="subname" placeholder="Enter Subname" required>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btnsave" aria-label="Save unit">Save</button>
