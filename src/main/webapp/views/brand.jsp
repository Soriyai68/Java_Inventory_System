                ...
                <div class="table-responsive">
                    <table id="table_id" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="Brand ID">BRD001</td>
                                <td data-label="Brand Name">TechTrend</td>
                                <td data-label="Description">High-quality electronics</td>
                                <td data-label="Option">
                                    <button class="btn btn-success btn-sm" aria-label="Edit brand">Edit</button>
                                    <button class="btn btn-danger btn-sm" aria-label="Delete brand">Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="modalTitle">Brand Form</h4>
                        ...
                        <div class="modal-body">
                            <form id="brandForm">
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback text-danger" style="display: none;">Please enter a brand name.</div>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" id="btnsave" aria-label="Save brand">Save</button>
